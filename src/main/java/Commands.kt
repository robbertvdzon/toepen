...
class MaakNieuweTafelsCommand(private val aantal:Int, val startscore:Int, val vulTafelsAanMetMonkeysTot:Int): Command(){
    override fun process():CommandResult = Administrator.maakNieuweTafels(aantal, startscore, vulTafelsAanMetMonkeysTot)
}
